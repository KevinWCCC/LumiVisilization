...
def main():
    ...
    fig.suptitle(
        ...
        f"48 Logical RGB Pixels → 144 Subpixels   |   color = intensity zone   |   marker = subchannel (R/G/B)   |   Hidden Dim = {H}\n"
        f"(b) MAX MIXING version: large jitter + random channel shuffle per zone → intensity clusters visible but R/G/B completely mixed inside",
